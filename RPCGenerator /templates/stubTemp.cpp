// {fname}.stub.cpp
// built by rpcgenerate program by Sam Hu and David Chen

// usage (of compiled program): ./{fname}server <server_name>
...
// ======================================================================
 ...
 // All the nonTrivial stub functions, filled using stubFuncTemp.cpp
{stubFuncs}
...
// TODO: fix format to fit 
void __badFunction(char *functionName) {{
  char doneBuffer[5] = "_BAD";  // to write magic value DONE + null
...
if (!RPCSTUBSOCKET-> eof()) {{
{dispatchCases} // note that this is joined by " else "
else {{
